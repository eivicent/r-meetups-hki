...
chocolate %>% 
  ...
  geom_text(aes(label = round(n/n_chocolates,2)), vjust = 2) +
  scale_fill_discrete(guide = "none") + 
  theme_minimal() + 
  labs(title = "Distinct characteristics used per chocolate",
       subtitle = "By % of cocoa in the chocolate",
       x = NULL,
       fill = NULL,
       y = NULL) +
  theme(panel.grid.major.y = element_blank(),
        ...
        axis.title = element_text(face = "plain", size = rel(0.9), color = "gray20", hjust = 0),
