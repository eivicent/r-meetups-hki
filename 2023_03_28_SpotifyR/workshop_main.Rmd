...
**In summary**, if you get an error when running some functions, you can run the snippet below to solve it.
...
add_tracks_to_playlist(
  playlist_id = '5D2UoHWtwQbF11GQTKqzpA', #get it from the output of the previous function
